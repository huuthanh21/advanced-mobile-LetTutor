...
class _HistoryPageState extends State<HistoryPage> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Gap(20),
                  FutureBuilder(
                    future: bookingDataProvider.getHistorySchedule(),
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        histories = snapshot.data as List<History>;
                        return Column(
                                    ...
                                    children: [
                                      Text(
                                        DateFormat('EEE, dd MMM yy', 'vi_VN')
                                            .format(histories[index].booking.dateTime),
                                    ...
                                    children: [
                                      SizedBox(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                                histories[index].booking.tutor.profilePictureUrl),
                                          )),
                                      const Gap(10),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ...
                                          Row(children: [
                                            CountryFlag.fromCountryCode(
                                                histories[index].booking.tutor.countryCode,
                                                width: 20,
                                                height: 20),
                                            const Gap(5),
                                            Text(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  if (histories[index].booking.request == null)
                                                    const Text(
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        const Gap(20),
                                                        Text(
                                                          histories[index].booking.request!,
                                                          style: const TextStyle(
                                                            fontFamily: 'Open Sans',
                                                            fontSize: 16,
                                                          ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  if (histories[index].grading == null)
                                                    const Text(
                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            const Gap(10),
                                                            Text(
                                                              'Lesson status: ${statusToText(histories[index].booking.status)}',
                                                              style: const TextStyle(
                                                                fontFamily: 'Open Sans',
                                                                fontSize: 16,
                                                              ),
  ...
  String statusToText(BookingStatus status) {
    switch (status) {
